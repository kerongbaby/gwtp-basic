...
class TokenStoreImpl implements TokenStore {
  ...
  public native void set(String key, String value) /*-{
    var obj = JSON.parse($wnd.localStorage.getItem(
        @com.risetek.demo.client.oauth.TokenStoreImpl::KEY) || '{}');
    obj[key] = value;
    $wnd.localStorage.setItem(
        @com.risetek.demo.client.oauth.TokenStoreImpl::KEY, JSON.stringify(obj));
  }-*/;

  public native String get(String key) /*-{
    return JSON.parse($wnd.localStorage.getItem(
        @com.risetek.demo.client.oauth.TokenStoreImpl::KEY) || '{}')[key] || '';
  }-*/;
