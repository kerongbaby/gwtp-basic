...
package com.risetek.demo.client.oauth;
...
class CookieStoreImpl extends TokenStoreImpl {
  ...
  public native void set(String key, String value) /*-{
    $doc.cookie = @com.risetek.demo.client.oauth.CookieStoreImpl::COOKIE_PREFIX +
        encodeURIComponent(name) + '=' + encodeURIComponent(value);
  }-*/;

  @Override
  public native String get(String key) /*-{
    var m = @com.risetek.demo.client.oauth.CookieStoreImpl::ensureCookies();
    return m[@com.risetek.demo.client.oauth.CookieStoreImpl::COOKIE_PREFIX + key];
  }-*/;

  @Override
  public native void clear() /*-{
    var allCookies = @com.risetek.demo.client.oauth.CookieStoreImpl::ensureCookies()();
    var prefix = @com.risetek.demo.client.oauth.CookieStoreImpl::COOKIE_PREFIX;

    for (var key in allCookies) {
      if (key.indexOf(prefix) == 0) {
        this.@com.risetek.demo.client.oauth.CookieStoreImpl::set(*)(
            key.substring(prefix.length), '');
      }
    }
    @com.risetek.demo.client.oauth.CookieStoreImpl::cachedCookies = null;
  }-*/;
  ...
  private static native void loadCookies() /*-{
    @com.risetek.demo.client.oauth.CookieStoreImpl::cachedCookies = {};
    ...
    if (docCookie && docCookie != '') {
      ...
      for ( var i = 0; i < crumbs.length; ++i) {
        ...
        @com.risetek.demo.client.oauth.CookieStoreImpl::cachedCookies[name] = value;
      }
    }
  }-*/;
